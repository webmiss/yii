...
$MenusLeft=[];
// 一级菜单
foreach($this->params['Menus']['Data'] as $val){
	if($val->id==$this->params['Menus']['CID'][0]){
		// 其他菜单
		$MenusLeft = $val->menus;
		$an = 'nav_an1';
	}else{
...
<?php }?>
		...
		<div class="top_link">
			...
			<span class="uname"><?php echo $this->params['Uinfo']['uname'];?></span>
			<span class="icon user">
				<em></em>
				<span class="info">
					<span class="ct">
						部门: <?php echo $this->params['Uinfo']['department'];?><br>
